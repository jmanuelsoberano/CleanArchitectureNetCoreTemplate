...
public class GetCourseVisualizerQueryHandler : IRequestHandler<GetCourseVisualizerQuery, Result<GetCourseVisualizerQueryResponse>>
{
    ...
    public async Task<Result<GetCourseVisualizerQueryResponse>> Handle(GetCourseVisualizerQuery request, CancellationToken cancellationToken)
    {
